...
* Enhanced Field class by adding table attribute `Field.table` and  parameter parsing with `Field.value, Field.param_domain_type, and Field.members properties                                                                            
